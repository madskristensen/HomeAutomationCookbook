...
<div class="planning-grid">
  ...
  <div class="planning-card">
    ...
    <ul>
      <li><strong>Entry level:</strong> $200-500</li>
      <li><strong>Mid-range:</strong> $500-2000</li>
      <li><strong>Advanced:</strong> $2000+</li>
    </ul>
  </div>
  ...
  <div class="planning-card">
    ...
    <ul>
      <li><strong>Beginner:</strong> Pre-configured solutions</li>
      <li><strong>Intermediate:</strong> Platform-based systems</li>
      <li><strong>Advanced:</strong> Custom integrations</li>
    </ul>
  </div>
</div>
